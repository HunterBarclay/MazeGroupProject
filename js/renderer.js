// On Load
document.addEventListener("ready", function () { startHelloWebGL(); });
...
async function getShader(gl, id) {
    ...
    var str = await shaderScript.addEventListener("onload", function (x) { return x.innerHTML; });
    console.log("Inner HTML: " + str);
    // var str = "";
